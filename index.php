...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .profile-card .body { padding: 22px; width: 100%; z-index: 11;position: absolute;bottom: 0; background: #050F2C;background: linear-gradient(0deg,rgba(5, 15, 44, 1) 0%, rgba(0, 156, 175, 0) 100%);}
